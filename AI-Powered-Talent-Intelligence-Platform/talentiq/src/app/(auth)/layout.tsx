      ...
      <div className="w-full md:w-1/2 bg-[#0F172A] hidden md:flex flex-col justify-between p-[48px] lg:p-[64px] relative overflow-hidden text-white">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-[60%] opacity-30 pointer-events-none">
          ...
          >
            <path
              fill="url(#gradient2)"
              d="M0,128L60,144C120,160,240,192,360,186.7C480,181,600,139,720,149.3C840,160,960,224,1080,229.3C1200,235,1320,181,1380,154.7L1440,128L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"
            ></path>
            <defs>
        ...
        <div className="relative z-10 flex-grow flex flex-col justify-center mt-[-40px]">
          <div className="max-w-[480px]">
            ...
            <h2 className="font-display text-[32px] lg:text-[40px] font-bold text-white leading-[1.2] mb-6">
              TalentIQ transformed our hiring process. We reduced time-to-hire
              by 62% in the first month.
            </h2>
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-body text-[16px] font-bold text-white leading-tight">
                  Ajinkya Saivar
                </p>
                <p className="font-body text-[14px] text-white/70 mt-0.5">
