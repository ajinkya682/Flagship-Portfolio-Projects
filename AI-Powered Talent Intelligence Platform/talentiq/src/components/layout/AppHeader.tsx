...
import { Search, Bell, X, LogOut, Settings, User } from "lucide-react"
...
export function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-[60px] w-full items-center justify-between border-b border-neutral-200 bg-white px-[32px]">
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Notifications */}
        <button className="relative flex h-[36px] w-[36px] items-center justify-center rounded-[var(--radius-sm)] text-neutral-500 hover:bg-neutral-100 hover:text-neutral-900 focus:outline-none focus:ring-2 focus:ring-primary-500">
          <Bell size={18} />
          {/* Badge */}
