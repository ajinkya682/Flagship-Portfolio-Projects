                ...
                <div className="bg-white rounded-[16px] border border-neutral-100 shadow-sm p-[24px]">
                  ...
                  <div className="flex flex-col gap-[16px]">
                    <div className="flex flex-col gap-[6px]">
                      ...
                      <input type="text" defaultValue="Acme Corp" className="h-[40px] px-[12px] bg-white border border-neutral-200 rounded-[8px] text-[13px] focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500" />
                    </div>
                    <div className="flex flex-col gap-[6px]">
                      ...
                      <div className="flex">
                        ...
                        <input type="text" defaultValue="acme" className="flex-1 h-[40px] px-[12px] bg-white border border-neutral-200 rounded-r-[8px] text-[13px] focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500" />
                      </div>
                    </div>
                  </div>
                  <div className="mt-[24px] pt-[20px] border-t border-neutral-100">
                    <button className="h-[38px] px-[20px] bg-blue-600 hover:bg-blue-700 text-white font-body text-[13px] font-semibold rounded-[8px] shadow-sm transition-colors">
                      Save Changes
                    </button>
                  </div>
                </div>
