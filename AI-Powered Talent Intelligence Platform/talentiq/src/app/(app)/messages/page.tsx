  ...
  return (
    <div className="flex flex-col h-full -mx-[16px] md:-mx-[32px] -mt-[16px] md:-mt-[32px] bg-neutral-50/50 min-h-[calc(100vh-60px)]">
      ...
      {messages.length === 0 && candidates.length === 0 ? (
        <div className="flex-1 flex overflow-hidden m-[16px] md:m-[24px] bg-white rounded-[16px] border border-neutral-200 shadow-sm items-center justify-center">
          <div className="flex flex-col items-center justify-center text-center p-[40px] max-w-[400px]">
            ...
            <h3 className="font-display text-[16px] font-bold text-neutral-900 mb-[8px]">No messages yet</h3>
            <p className="font-body text-[13px] text-neutral-500 mb-[20px]">
              You don't have any candidates to message. Add candidates to your pipeline to start a conversation.
            </p>
            <Link 
              href="/pipeline"
